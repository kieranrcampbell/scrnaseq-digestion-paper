...
gs <- GeneSet(heat_genes, geneIdType = SymbolIdentifier(), setName = "scrnaseq-digestion-temperature")

toGmt(gs, "../../data/deliverables/scrnaseq-digestion-temperature.gmt")
```

And save the full data frame

```{r}
write_csv(dfc, "../../data/temp_de_all.csv")
```
