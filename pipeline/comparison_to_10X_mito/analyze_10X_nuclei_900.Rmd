---
title: "Analyze 10X nuclei_900 data"
...
Downloaded from https://support.10xgenomics.com/single-cell-gene-expression/datasets/2.0.1/nuclei_900

Read in the data:

```{r}
sce <- read10xCounts("../../data/raw_10X/10X_nuclei_900/filtered_gene_bc_matrices/mm10/")
print(sce)
```
