...
ggsave("../../figs/all_sample_analyses/pct_counts_mito_all_samples.png", width = 20, height = 15)
```
...
```{r}
umap_plot <- readRDS("../../figs/all_sample_analyses/umap_all.rds")

# umap_plot <- umap_plot + theme(legend.position = "bottom") +
#   geom_point(aes(colour = sample_type), alpha = 0.5, size = 0.01)

upper_grid <- cowplot::plot_grid(
  grid_plot,ridge_plot,
  labels = c("a", "b"),
  nrow = 1
)
...
ggsave("../../figs/all_sample_analyses/all_sample_overview.png", plot = full_plot, width = 10, height = 8.5)
```
